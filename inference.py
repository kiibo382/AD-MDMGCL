...
def parse_arguments():
    ...
    p.add_argument('--config', type=argparse.FileType(mode='r'), default='configs/fingerprint_inference.yml')
    ...
    p.add_argument('--trainer', type=str, default='fine_tune', help='[3dinfomax, byol, alternating, philosophy]')
