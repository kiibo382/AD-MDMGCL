...
class AD_MDMGCL_Loss(_Loss):
    def __init__(
        ...
        super(AD_MDMGCL_Loss, self).__init__()
    ...
    def forward(self, view2d, view2d_aug, view3d, **kwargs) -> Tensor:
        adgcl_loss = self.infonce(
            view2d, view2d_aug, **kwargs
        )
        loss_2d_3d = self.infonce(
            view2d, view3d, **kwargs
        )
        print("adgcl_loss", adgcl_loss.item())
        print("loss_2d_3d", loss_2d_3d.item())
        return adgcl_loss + self.lambda_3d * loss_2d_3d
